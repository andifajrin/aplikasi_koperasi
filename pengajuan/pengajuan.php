...
<div class="row mt">
 <div class="col-lg-12">
  <div class="form-panel">
   ...
   <?php  $verida=mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM t_pengajuan where kode_anggota='$kodeaa' order by kode_pengajuan desc")); $num=mysql_num_rows($verida);
